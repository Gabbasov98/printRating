$(".filter-item__show").click((function(){$(this).parents(".filter-item").hasClass("_open")?$(".filter-item").removeClass("_open"):($(".filter-item").removeClass("_open"),$(this).parents(".filter-item").addClass("_open"))})),$(document).mouseup((function(e){let t=$(".filter-item");t.is(e.target)||0!==t.has(e.target).length||$(t).hasClass("_open")&&$(t).removeClass("_open")}));let serviceFilter=[],metroFilter=[];function setSelectedFilter(){serviceFilter=[],metroFilter=[];let e=$('[name="service"]:checked');$(e).each((function(e,t){serviceFilter.push({id:$(t).attr("data-id"),value:$(t).attr("data-value")})}));let t=$('[name="metro"]:checked');$(t).each((function(e,t){metroFilter.push({id:$(t).attr("data-id"),value:$(t).attr("data-value")})})),console.log(serviceFilter)}function renderFilters(){$(".selected-filters").html(""),serviceFilter.forEach(e=>{$(".selected-filters").append(`\n        <div data-id="${e.id}" class="selected-filter">\n            <span class="text14">${e.value}</span>\n            <button class="selected-filter__remove">\n                <img src="img/close2.svg" alt="">\n            </button>\n        </div>\n        `)}),metroFilter.forEach(e=>{$(".selected-filters").append(`\n        <div data-id="${e.id}" class="selected-filter">\n            <span class="text14">${e.value}</span>\n            <button class="selected-filter__remove">\n                <img src="img/close2.svg" alt="">\n            </button>\n        </div>\n        `)}),$(".selected-filter__remove").click((function(){let e=$(this).parents(".selected-filter").attr("data-id");$(`[data-id="${e}"]`).prop("checked",!1),setSelectedFilter(),renderFilters()}))}$('[name="sort"]').change((function(){$(".filter-item").removeClass("_open")})),$('[name="service"],[name="metro"]').change((function(){setSelectedFilter(),renderFilters(),$(".filter-item").removeClass("_open")})),setSelectedFilter(),renderFilters();
